...
DROP TABLE IF EXISTS Mid_Level_Manage_Activity;
DROP TABLE IF EXISTS Employee_Work_On;
DROP TABLE IF EXISTS Temp_Employee_Work_On;
DROP TABLE IF EXISTS Applied_To;
DROP TABLE IF EXISTS TempSupervise;
DROP TABLE IF EXISTS Employee_Supervision;
DROP TABLE IF EXISTS Contractor_Company;
